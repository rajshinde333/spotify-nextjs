    ...
    <div className="flex flex-col items-center justify-center bg-black min-h-screen w-full">
      ...
      {Object.values(providers).map((provider) => (
        <div key={provider.name}>
          <button
            className="bg-[#18D860] p-2 rounded-full mt-5 hover:bg-black hover:border-[#18D860] border-transparent border-2 hover:text-white focus:ring focus:ring-[#18D860] focus:bg-black focus:text-white md:p-3 xl:p-3 md:text-lg xl:text-xl"
